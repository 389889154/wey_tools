...
- (void)viewDidLoad {
    ...
    NSMutableArray *urlArray = [NSMutableArray arrayWithObjects:string, string1, string2,nil];
    ...
    // 刷新页面
    self.cycleScrollView.featchContentViewAtIndex = ^UIView *(NSInteger pageIndex) {
